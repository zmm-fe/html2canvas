...
* backgroundRepeat backgroundImage blurry  object-fit ([452bbf5](https://github.com/niklasvh/html2canvas/commit/452bbf597ff5777c2feb9503974b562996369e1a))
...
* mobile emvironment use crossOrigin anonymous need set random query ([1ec29c9](https://github.com/niklasvh/html2canvas/commit/1ec29c985cdd3aa365004f157da490c3616f20af))
...
* UI error by text-decoration-thickness when using underline on the mobile env ([6284d54](https://github.com/niklasvh/html2canvas/commit/6284d542b14176fb28b0d6e5cad9d31a7989eddd))
* UI error when using underline on the mobile env ([7e5cb30](https://github.com/niklasvh/html2canvas/commit/7e5cb30c006ba9fc8382aa9da07f64743034694a))
